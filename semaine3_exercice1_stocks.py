...
print(" Ruptures critiques : 2 (SRO, Vaccin DTP)")
print(" Alertes stock : 2 (Artemether, Amoxicilline)")
print(" Stocks normaux : 1 (Paracetamol)")
print("=" * 64)
