...
print("   couverture      :", couverture_sociale)
print("-"*60)
print("   CONSULTATION")
print("   Type            : ",type_consultation )
print("   Diagnostic      : ", diagnostic_principal)
print("   Cout unitaire   : ", cout_consultation_fcfa)
print("   Remise CNSS     : ",remise_cnss_pct)
print("   COUT TOTAL      : ",cout_total_fcfa)
print("-"*60)
print("   HOPITAL         :", nom_hopital)
print("   Ville           :", ville_hopital)
print("   Lits occupés    :", taux_occupation_pct, "%")
print("   Medecins actifs :", nb_medecins_actifs)
print("   Ratio consult.  :", ratio_consultations_medecin)
print("="*60)
